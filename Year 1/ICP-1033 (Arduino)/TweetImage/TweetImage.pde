...
void setup() {
   ...
   */
  simpletweet.setOAuthConsumerKey("pwAt5EoMD6yCyibMZdXYdRxA5");
  simpletweet.setOAuthConsumerSecret("YJNQncwz97mKf0WFjssheW4XUuCD7FGwGIR4Mppqm3LC6TyIEu");
  simpletweet.setOAuthAccessToken("1103586018198994944-05Bq7iTh03YpR82G0Mn28bGMwkLRRX");
  simpletweet.setOAuthAccessTokenSecret("9IclaaXwFdjkmnwlnNp14yWfH9AIEVTB7aBIiLAsOoybK");
}
...
void mousePressed() {
  String tweet = simpletweet.tweetImage(get(), "Made with Processing #setalarmbot42");

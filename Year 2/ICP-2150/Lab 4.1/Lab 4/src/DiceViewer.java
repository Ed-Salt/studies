...
public class DiceViewer {
	...
	private static int sides = 6;		//max roll
	private static int diceSize = 160;	//dice width/height
	private static int leftDice = 100;	//black die x position
	private static int rightDice = 444;	//red die x position
	private static int yPos = 80;		//dice y position
	private static String mode = "";	//holds the current play mode
    private static Random generator = new Random();	//random number generator
	private static int bet = 1;			//holds the current bet amount
	private static int bal = 50;		//holds the current balance
